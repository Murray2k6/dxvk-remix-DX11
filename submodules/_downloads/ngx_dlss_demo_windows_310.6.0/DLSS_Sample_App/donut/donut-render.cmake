...
set(donut_src_ngx
    ...
    src/render/plugins/DlssPass.cpp
)
...
if(DONUT_WITH_NGX)
    target_sources(donut_render PRIVATE ${donut_src_ngx})
    target_link_libraries(donut_render ngx)
    target_compile_definitions(donut_render PUBLIC DONUT_WITH_NGX)
endif()
