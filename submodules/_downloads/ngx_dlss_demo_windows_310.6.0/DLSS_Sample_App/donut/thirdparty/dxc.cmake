...
set(__dxc_package_path ${CMAKE_CURRENT_SOURCE_DIR}/dxc/)

if (NOT DEFINED DXC_BIN_SPIRV)
    if (WIN32)
        if (NOT EXISTS ${__dxc_package_path}/bin/x64/dxc.exe)
        ...
        set(DXC_BIN_SPIRV ${__dxc_package_path}/bin/x64/dxc.exe CACHE FILEPATH "" FORCE)
    else()
