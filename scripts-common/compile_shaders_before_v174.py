#!/usr/bin/env python3
# DX11_V173_DX11_SHADER_MODE_NO_D3D11
...
ORIG = SCRIPT_DIR / "compile_shaders_orig_v173.py"
for fallback_name in (
    "compile_shaders_orig_v173.py",
    "compile_shaders_orig_v173.py",
    "compile_shaders_orig_v173.py",
    "compile_shaders_orig_v173.py",
    "compile_shaders_orig_v173.py",
...
def main() -> int:
    if not ORIG.is_file():
        print(f"DX11_V173_DX11_SHADER_MODE_NO_D3D11: original compiler missing: {ORIG}", file=sys.stderr)
        return 2
    ...
    with tempfile.TemporaryDirectory(prefix="dx11_v173_shader_fulltree_", ignore_cleanup_errors=True) as td:
        temp_root = Path(td)
        ...
        if output_dir is not None:
            ...
            report = output_dir / "dx11_v173_dx11_shader_mode_report.txt"
            report.write_text(
                "DX11_V173_DX11_SHADER_MODE_NO_D3D11\n"
        ...
        print(
            "DX11_V173_DX11_SHADER_MODE_NO_D3D11: compiling real Remix runtime shaders "
