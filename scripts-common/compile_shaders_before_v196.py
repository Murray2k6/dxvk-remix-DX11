#!/usr/bin/env python3
# DX11_V193_PY314_SAFE_SHADER_WRAPPER
...
def _select_original() -> Path | None:
    candidates = [
        SCRIPT_DIR / "compile_shaders_real_original_v193.py",
        SCRIPT_DIR / "compile_shaders_orig_clean_v193.py",
        SCRIPT_DIR / "compile_shaders_orig_v193.py",
        SCRIPT_DIR / "compile_shaders_orig_v193.py",
        SCRIPT_DIR / "compile_shaders_before_v193.py",
        SCRIPT_DIR / "compile_shaders_before_v193.py",
...
def main() -> int:
    ...
    if orig is None:
        print("DX11_V193_PY314_SAFE_SHADER_WRAPPER: no clean original compile_shaders.py found. No fake shader output was generated.", file=sys.stderr)
        return 2
    ...
    with tempfile.TemporaryDirectory(prefix="dx11_v193_shader_fulltree_", ignore_cleanup_errors=True) as td:
        temp_root = Path(td)
        ...
        if output_dir is not None:
            ...
            report = output_dir / "dx11_v193_py314_safe_shader_wrapper_report.txt"
            report.write_text(
                "DX11_V193_PY314_SAFE_SHADER_WRAPPER\n"
        ...
        print(
            "DX11_V193_PY314_SAFE_SHADER_WRAPPER: compiling real Remix runtime shaders "
