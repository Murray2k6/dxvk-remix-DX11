...
namespace dxvk {
  ...
  struct DxsoOptions {
    DxsoOptions();
    DxsoOptions(D3D11DeviceEx* pDevice, const D3D11Options& options);
    ...
    /// Whether to emulate d3d11 float behaviour using clampps
    /// True:  Perform emulation to emulate behaviour (ie. anything * 0 = 0)
    /// False: Don't do anything.
    D3D11FloatEmulation d3d11FloatEmulation;
