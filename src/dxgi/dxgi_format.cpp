...
namespace dxvk {
  ...
  const std::array<DXGI_VK_FORMAT_MAPPING, 133> g_dxgiFormats = {{
    ...
    // 422 formats require samplerYcbcrConversion — remap to RGBA8.
    { VK_FORMAT_R8G8B8A8_UNORM,
      VK_FORMAT_UNDEFINED,
      VK_FORMAT_R8G8B8A8_UINT,
      VK_IMAGE_ASPECT_COLOR_BIT },
    ...
    { }, // Unsupported
    // DXGI_FORMAT_NV12
    // Planar 420 requires samplerYcbcrConversion which Remix doesn't enable.
    // Mark unsupported so apps fall back to software decode instead of crashing.
    { }, // Unsupported
    // DXGI_FORMAT_P010
    { }, // Unsupported
    // DXGI_FORMAT_P016
    ...
    { }, // Unsupported (same reason as NV12)
    // DXGI_FORMAT_YUY2
    // Native VK_FORMAT_G8B8G8R8_422_UNORM requires samplerYcbcrConversion
    // which Remix doesn't enable. Map to R8G8B8A8 — same byte layout, apps
    // (Dolphin, etc.) decode the packed YUYV bytes in their own shaders.
    { VK_FORMAT_R8G8B8A8_UNORM,
      VK_FORMAT_UNDEFINED,
      VK_FORMAT_R8G8B8A8_UINT,
      VK_IMAGE_ASPECT_COLOR_BIT },
  ...
  const std::array<DXGI_VK_FORMAT_FAMILY, 133> g_dxgiFamilies = {{
    ...
    { }, // Unsupported
    // DXGI_FORMAT_NV12
    { }, // Unsupported (planar 420, no ycbcr conversion)
    // DXGI_FORMAT_P010
    { }, // Unsupported
    // DXGI_FORMAT_P016
    { }, // Unsupported
