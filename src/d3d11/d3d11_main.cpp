...
void logRemixDx11BuildBanner() {
  ...
  dxvk::Logger::info("[Remix-DX11] fixes: nrcVendorFallback texcoordSINT SR4viewport budgetHeadroom inputSeparation grayPlaceholder crossVendorDLSSGuard initStepLogging");
